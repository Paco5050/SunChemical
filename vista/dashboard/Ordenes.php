                        ...
                        <tbody>
                            <tr class="align-middle">
                                ...
                                <td class="col-lg-3 ">
                                    ...
                                    <button type="button" class="btn btn-primary col col-lg-6 me-3 p-0" data-bs-toggle="modal" data-bs-target="#staticBackdrop2">
                                        Procesar Factura
                                    </button>                                    
                                    </div>
                                </td>
    ...
    <div class="modal fade col-lg-12" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ¿Está seguro de generar la siguiente factura?
            </div>
