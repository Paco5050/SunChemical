...
<body class="g-0">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <h1 class="display-6">Administración de Empresa
                    ...
                    <table id="tablaPersonas" class="table table-striped table-bordered table-condensed" style="width:100%">
                        ...
                        <tbody>
                            <tr class="align-middle">
                                <td>1</td>
                                <td>MarketFar</td>
                                <td>Alimentos y farmacos</td>
                                <td>Activa</td>    
                                <td>marketfar2021@gmail.com</td> 
                                <td class="col-lg-2 ">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Actualizar Empresa</h5>
                ...
                <div class="modal-body">
                    <form class="row g-3 needs-validation ms-2 mt-2" novalidate>
                        <div class="row">    
                            ...
                            <div class="col-md-6">
                                <label for="validationCustom01" class="form-label">Tipo Empresa</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="validationCustom01" class="form-label">Estado Empresa</label>
                                <select class="form-select" id="validationCustom04" required>
                                <option selected disabled value="">Escoje...</option>
                                <option>...</option>
                                </select>
